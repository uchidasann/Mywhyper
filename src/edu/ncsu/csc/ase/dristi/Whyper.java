...
*/
	private static boolean isUserOwned(Tuple t, ITuple t1) {
		ITuple t_parent = t.findParent(t1);
		ITuple t_Sibling = t.findSibling(t1);
		String comp_Value = "";
		if ((t_parent != null) && !t_parent.same(t1)) {
			comp_Value = t_parent.getRelation().getName();
